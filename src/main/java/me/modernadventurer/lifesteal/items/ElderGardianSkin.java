...
public class ElderGardianSkin extends Item implements PolymerItem {
    public ElderGardianSkin(Item.Settings settings) {
        super(settings);
    }
    ...
    public Identifier getPolymerItemModel(ItemStack itemStack, PacketContext context) {
        return Identifier.of(Loader.MOD_ID, "eldergardianskin");
    }
